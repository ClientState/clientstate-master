...
(function() {
  var App, Container, ProviderIDSecret, ProviderLoginDetails, User, assert, expect, models, _ref, _ref1;

  models = (_ref = require("../models"), User = _ref.User, ProviderIDSecret = _ref.ProviderIDSecret, ProviderLoginDetails = _ref.ProviderLoginDetails, App = _ref.App, Container = _ref.Container, _ref);
  ...
  describe('Launch Redis Service', function() {
    beforeEach(function(done) {
      return new App({
        id: "theid",
        secret: "thesecret",
  ...
  describe('Relaunch Redis Service', function() {
    beforeEach(function(done) {
      return new App({
        id: "theid",
        secret: "thesecret",
    ...
    return it('makes correct calls when app.relaunch_service', function(done) {
      return new App({
        id: "theid"
      }).fetch().then(function(app) {
        var opts;
        opts = {};
        return app.containers().fetch().then(function(collection) {
          assert.equal(collection.models.length, 1);
          assert.equal(collection.models[0].id, "foobar1");
          return app.relaunch_service(opts, function() {
            return app.containers().fetch().then(function(collection) {
              var env;
